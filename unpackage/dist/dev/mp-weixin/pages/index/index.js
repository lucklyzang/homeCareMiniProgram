...
try {
  components = {
    ...
    uRate: function () {
      return __webpack_require__.e(/*! import() | node-modules/uview-ui/components/u-rate/u-rate */ "node-modules/uview-ui/components/u-rate/u-rate").then(__webpack_require__.bind(null, /*! uview-ui/components/u-rate/u-rate.vue */ 285))
    },
  }
} catch (e) {
  if (
...
var _lodash = _interopRequireDefault(__webpack_require__(/*! lodash */ 105));
...
var _default = {
  ...
  data: function data() {
    return {
      ...
      nurseList: [{
        text: '健康护理',
        icon: __webpack_require__(/*! @/static/img/health-nurse.png */ 107)
      }, {
        text: '妈妈护理',
        icon: __webpack_require__(/*! @/static/img/mother-nurse.png */ 108)
      }, {
        text: '宝宝护理',
        icon: __webpack_require__(/*! @/static/img/baby-nurse.png */ 109)
      }, {
        text: '慢病看护',
        icon: __webpack_require__(/*! @/static/img/chronic-disease-nurse.png */ 110)
      }],
      searchValue: '',
