		...
		<view class="order-form-list-wrapper">
				...
				<view class="evaluate-message-bottom">
					<view class="service-attitude">
						...
						<view class="service-attitude-score">
							<u-rate active-color="#F2A15F" size="40" :count="serviceAttitudeCount" v-model="serviceAttitudeValue"></u-rate>
						</view>
					</view>
					<view class="service-attitude">
						<view class="service-attitude-title">
						...
						<view class="service-attitude-score">
							<u-rate active-color="#F2A15F" size="40" :count="serviceAttitudeCount" v-model="serviceSpeedValue"></u-rate>
						</view>
					</view>
					<view class="service-attitude">
						<view class="service-attitude-title">
						...
						<view class="service-attitude-score">
							<u-rate active-color="#F2A15F" size="40" :count="serviceAttitudeCount" v-model="majorLevelValue"></u-rate>
						</view>
					</view>
			...
			<view class="order-flow">
				...
				<view class="order-flow-content">
					<u-steps :list="orderFormTypeList" un-active-color="#D9DBE0" active-color="#fff" :current="6"></u-steps>
				</view>
			</view>
